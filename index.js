...
let filterByExchange = (exchange) => {
  return stocks.filter(stock => stock.exchange.toLowerCase() === stock.exchange.toLowerCase());
}
...
let filterByIndustry = (industry) => {
  return stocks.filter(stock => stock.industry.toLowerCase() === stock.industry.toLowerCase());
}
